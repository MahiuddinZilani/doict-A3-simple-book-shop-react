...
function Home() {
  ...
  return (
    <>
      <Banner></Banner>
      <hr />
      <div className="mx-auto  container sticky top-[60px] z-10">
      ...
      <div className=" mx-auto h-max container grid place-items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {books.map((book) => (
