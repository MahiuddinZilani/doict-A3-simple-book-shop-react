    ...
    <div className="bg-gray-100 min-h-screen py-12">
        ...
        <div className="lg:flex lg:items-center lg:gap-8">
          ...
          <div className="lg:w-1/2 mt-6 lg:mt-0">
            ...
            <p className="mt-4 text-gray-600">
              ...
              meets a passion for community. Our bookstore was founded with the
              vision to create a welcoming space for book lovers of all ages,
              where stories come to life.
            </p>
            <p className="mt-4 text-gray-600">
              Whether you’re looking for the latest bestseller or a timeless
              classic, our curated collection offers something for everyone. Our
              knowledgeable staff is always here to guide you through your
              literary journey.
            </p>
          </div>
        </div>
      ...
      <div className="container mx-auto mt-16 px-4">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            carefully selected books, community events, and author readings, we
            strive to create a space where ideas flourish and readers find joy
            in every page.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto mt-16 px-4">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
            We believe that books have the power to connect people and foster a
            sense of belonging. Join our community by visiting us, signing up
            for our newsletter, or attending one of our many events!
          </p>
